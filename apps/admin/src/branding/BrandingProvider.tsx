...
/**
 * Fetches the admin-managed brand assets. The `['branding']` query key is what
 * BrandingPage invalidates after an upload, so the sidebar mark updates without
 * a reload. A failure here is non-fatal — consumers fall back to the built-in mark.
 */
